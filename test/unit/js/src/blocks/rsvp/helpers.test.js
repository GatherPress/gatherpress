 ...
 */
import { parseSerializedInnerBlocks } from '@src/blocks/rsvp/helpers';
 ...
 * block attribute (double-nested JSON). When something leaves that stored
 * string malformed, the editor hit an unguarded `JSON.parse` on every render
 * and crashed the whole block into Gutenberg's error boundary. The guard
