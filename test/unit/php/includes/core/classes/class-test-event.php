...
class Test_Event extends Base {
	...
	public function test_get_calendar_links(): void {
		...
		$expected_google_link = 'https://www.google.com/calendar/event?action=TEMPLATE&text=Unit+Test+Event&dates=20200511T150000Z%2F20200511T170000Z&details=' . rawurlencode( $description ) . '&location=Unit+Test+Venue%2C+123+Main+Street%2C+Montclair%2C+NJ+07042&sprop=name%3A';
		$expected_yahoo_link  = 'https://calendar.yahoo.com/?v=60&view=d&type=20&title=Unit+Test+Event&st=20200511T150000Z&dur=0200&desc=' . rawurlencode( $description ) . '&in_loc=Unit+Test+Venue%2C+123+Main+Street%2C+Montclair%2C+NJ+07042';
