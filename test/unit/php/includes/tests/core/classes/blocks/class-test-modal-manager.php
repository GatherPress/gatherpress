...
class Test_Modal_Manager extends Base {
	...
	public function test_open_behavior_with_button(): void {
		...
		$input_html  = '<div class="gatherpress--has-modal-trigger"><button>Button</button></div>';
	...
	public function test_open_behavior_with_link(): void {
		...
		$input_html  = '<div class="gatherpress--has-modal-trigger"><a href="#">Open Modal</a></div>';
		$output_html = $instance->attach_modal_open_behavior( $input_html );
	...
	public function test_open_behavior_with_multiple_elements(): void {
		...
		$input_html  = '
			<div>
				<div class="gatherpress--has-modal-trigger"><button>Button</button></div>
				<p>Regular content</p>
				<div class="gatherpress--has-modal-trigger"><button>Button</button></div>
			</div>
		';
	...
	public function test_open_behavior_with_mixed_classes(): void {
		...
		$input_html  = '<div class="custom-class gatherpress--has-modal-trigger another-class"><button>Button</button></div>';
		$output_html = $instance->attach_modal_open_behavior( $input_html );
	...
	public function test_close_behavior_with_button(): void {
		...
		$input_html  = '<div class="gatherpress--has-modal-trigger" data-close-modal="true"><button type="button">Close Modal</button></div>';
	...
	public function test_close_behavior_with_link(): void {
		...
		$input_html  = '<div class="gatherpress--has-modal-trigger" data-close-modal="true"><a href="#">Close Modal</a></div>';
		$output_html = $instance->attach_modal_close_behavior( $input_html );
	...
	public function test_close_behavior_with_multiple_elements(): void {
		...
		$input_html  = '
			<div>
				<div class="gatherpress--has-modal-trigger" data-close-modal="true"><button type="button">Close First Modal</button></div>
				<p>Regular content</p>
				<div class="gatherpress--has-modal-trigger" data-close-modal="true"><a href="#">Close Second Modal</a></div>
			</div>
		';
		$output_html = $instance->attach_modal_close_behavior( $input_html );
	...
	public function test_close_behavior_with_mixed_classes(): void {
		...
		$input_html  = '<div class="custom-class gatherpress--has-modal-trigger another-class" data-close-modal="true"><button type="button">Close Modal</button></div>';
		$output_html = $instance->attach_modal_close_behavior( $input_html );
