...
function gatherpress_create_test_event_with_rsvp() {
	...
	update_post_meta(
		...
		gmdate( 'Y-m-d\TH:i:s', strtotime( '+7 days +2 hours' ) )
	);
...
<div class="wp-block-gatherpress-modal-manager"><!-- wp:buttons {"metadata":{"name":"Call to Action"},"align":"center",
"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"tagName":"button","metadata":{"name":"RSVP Button"},
"className":"gatherpress-modal--trigger-open"} -->
<div class="wp-block-button gatherpress-modal--trigger-open"><button type="button"
class="wp-block-button__link wp-element-button">RSVP</button></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
class="wp-block-gatherpress-modal-content has-contrast-color has-white-background-color has-text-color has-background">
<!-- wp:paragraph {"metadata":{"name":"RSVP Heading"},"style":{"spacing":{"margin":{"top":"0"},
"padding":{"top":"0"}}}} -->
...
<!-- wp:gatherpress/form-field {"fieldType":"checkbox","fieldName":"gatherpress_rsvp_anonymous",
"label":"List me as anonymous","autocomplete":"off","className":"gatherpress-rsvp-field-anonymous"} /-->

<!-- wp:buttons {"metadata":{"name":"Call to Action"},"align":"left",
"style":{"spacing":{"margin":{"bottom":"0"},"padding":{"bottom":"0"}}},
"layout":{"type":"flex","justifyContent":"flex-start"}} -->
<div class="wp-block-buttons" style="margin-bottom:0;padding-bottom:0">
<!-- wp:button {"tagName":"button","metadata":{"name":"RSVP Button"},
"className":"gatherpress-rsvp--trigger-update"} -->
<div class="wp-block-button gatherpress-rsvp--trigger-update"><button type="button"
class="wp-block-button__link wp-element-button">Attend</button></div>
<!-- /wp:button -->

<!-- wp:button {"tagName":"button","metadata":{"name":"Close Button"},
"className":"is-style-outline gatherpress-modal--trigger-close"} -->
<div class="wp-block-button is-style-outline gatherpress-modal--trigger-close"><button type="button"
class="wp-block-button__link wp-element-button">Close</button></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
...
<div style="padding:20px;max-width:400px"
class="wp-block-gatherpress-modal-content has-contrast-color has-white-background-color has-text-color has-background">
<!-- wp:paragraph {"metadata":{"name":"Login Heading"},"style":{"spacing":{"margin":{"top":"0"},
"padding":{"top":"0"}}}} -->
...
<p class="gatherpress--has-login-url">This action requires an account.
Please <a href="#gatherpress-login-url">Login</a> to RSVP to this event.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"metadata":{"name":"Register Info"},"className":"gatherpress--has-registration-url"} -->
<p class="gatherpress--has-registration-url">Don't have an account?
<a href="#gatherpress-registration-url">Register here</a> to create one.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button gatherpress-modal--trigger-close"><button type="button"
class="wp-block-button__link wp-element-button">Close</button></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:gatherpress/modal-content --></div>
