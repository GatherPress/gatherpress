...
const Edit = props => {
  ...
  const excerptMax = 55;
  const topicSuggestions = (_topicsList$reduce = topicsList === null || topicsList === void 0 ? void 0 : topicsList.reduce((accumulator, topic) => ({
    ...accumulator,
    [topic.name]: topic
...
const AttendanceSelector = _ref => {
  ...
  const getModalLabel = status => {
    switch (status) {
      case 'attending':
        return (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("You're Attending", 'gatherpress');
      case 'waiting_list':
        return (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("You're Wait Listed", 'gatherpress');
    }
    return '';
  };
  ...
  }, getModalLabel(attendanceStatus) ? getModalLabel(attendanceStatus) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Spinner, null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
const EventItem = props => {
  ...
  const venue = event.venue ? (0,html_react_parser__WEBPACK_IMPORTED_MODULE_1__["default"])('<a href=' + event.venue.permalink + '>' + event.venue.name + '</a>') : null;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, event.datetime_start)), venue && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, "Venue: ", venue), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    type: type,
    status: (_event$current_user = event.current_user) === null || _event$current_user === void 0 ? void 0 : _event$current_user.status
  })));
};
...
const EventsList = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if ('object' === typeof topics) {
      var _topics$map;
      topicsString = (_topics$map = topics.map(topic => {
        return topic.slug;
      })) === null || _topics$map === void 0 ? void 0 : _topics$map.join(',');
    }
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"gatherpress/events-list","version":"0.1.1","title":"Events List","category":"gatherpress","icon":"clock","example":{},"description":"A block listing events.","attributes":{"eventOptions":{"type":"object","default":{"descriptionLimit":55,"imageSize":"default","showAttendeeList":true,"showFeaturedImage":true,"showDescription":true,"showRsvpButton":true}},"maxNumberOfEvents":{"type":"integer","default":5},"topics":{"type":"array","items":{"type":"object"}},"type":{"type":"string","default":"upcoming"}},"supports":{"html":false},"textdomain":"gatherpress","editorScript":"file:./index.js","style":"file:./style-index.css"}');
