...
const RsvpResponse = () => {
  ...
  const items = [{
    ...
    title: false === hasEventPast ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__._x)('Not Attending', 'responded not attending', 'gatherpress') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Didn't Go", 'gatherpress'),
    value: 'not_attending'
  }];
...
const RsvpResponseHeader = ({
  ...
  if ((0,_helpers_globals__WEBPACK_IMPORTED_MODULE_5__.getFromGlobal)('eventDetails.responses')[activeValue]) {
    defaultRsvpSeeAllLink = (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_5__.getFromGlobal)('eventDetails.responses')[activeValue].count > defaultLimit;
  }
...
const RsvpResponseNavigation = ({
  ...
  for (const [key, value] of Object.entries((0,_helpers_globals__WEBPACK_IMPORTED_MODULE_4__.getFromGlobal)('eventDetails.responses'))) {
