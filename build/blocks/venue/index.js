...
const Edit = ({
  ...
  const [latitude, setLatitude] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useState)('');
  const [longitude, setLongitude] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useState)('');
  ...
  const onlineEventLink = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select('core/editor')?.getEditedPostAttribute('meta')?.gatherpress_online_event_link);
  let {
    mapShow
  } = attributes;
  let venueInformationMetaData = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select('core/editor')?.getEditedPostAttribute('meta')?.gatherpress_venue_information);
  ...
  }), mapShow && !isOnlineEventTerm && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_MapEmbed__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
/* harmony import */ var _GoogleMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GoogleMap */ "./src/components/GoogleMap.js");
/* harmony import */ var _LeafletMap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./LeafletMap */ "./src/components/LeafletMap.js");
...
const MapEmbed = props => {
  ...
  const mapPlatform = (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_4__.getFromGlobal)('settings.mapPlatform');
  const {
    zoom,
    type,
    className,
  ...
  if (mapPlatform === 'google') {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_GoogleMap__WEBPACK_IMPORTED_MODULE_2__["default"], {
      location: location,
      className: className,
      zoom: zoom,
      type: type,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_LeafletMap__WEBPACK_IMPORTED_MODULE_3__["default"], {
    location: location,
    latitude: latitude,
    longitude: longitude,
    className: className,
