...
const Edit = ({
  ...
  const onlineEventLink = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select('core/editor')?.getEditedPostAttribute('meta')?.online_event_link);
  let {
    mapShow
  } = attributes;
  let venueInformationMetaData = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select('core/editor')?.getEditedPostAttribute('meta')?.venue_information);
