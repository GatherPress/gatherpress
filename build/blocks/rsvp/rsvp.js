...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_1___default()(() => {
  ...
  const type = true === (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('has_event_past') ? 'past' : 'upcoming';
  for (let i = 0; i < containers.length; i++) {
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createRoot)(containers[i]).render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Rsvp__WEBPACK_IMPORTED_MODULE_2__["default"], {
      eventId: (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('post_id'),
      currentUser: (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('current_user'),
      type: type
    }));
  }
});
