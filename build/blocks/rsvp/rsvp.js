...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_0___default()(() => {
  ...
  const type = true === (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('eventDetails.hasEventPast') ? 'past' : 'upcoming';
  for (let i = 0; i < containers.length; i++) {
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createRoot)(containers[i]).render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_components_Rsvp__WEBPACK_IMPORTED_MODULE_2__["default"], {
      postId: (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('eventDetails.postId'),
      currentUser: (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('eventDetails.currentUser'),
      type: type,
      enableAnonymousRsvp: (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('eventDetails.enableAnonymousRsvp'),
      enableInitialDecline: (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('eventDetails.enableInitialDecline'),
      maxGuestLimit: (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_3__.getFromGlobal)('eventDetails.maxGuestLimit')
    }));
  }
});
})();
