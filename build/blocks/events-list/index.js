...
const EventsList = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const endpoint = (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_4__.getFromGlobal)('urls.eventRestApi') + `/events-list?event_list_type=${type}&max_number=${maxNumberOfEvents}&datetime_format=${datetimeFormat}&topics=${topicsString}&venues=${venuesString}`;
...
const Rsvp = ({
  ...
  const onAnchorClick = async (e, status, anonymous, guests = 0, close = true) => {
    ...
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default()({
      path: (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_9__.getFromGlobal)('urls.eventRestApi') + '/rsvp',
      method: 'POST',
      data: {
        post_id: postId,
        status,
