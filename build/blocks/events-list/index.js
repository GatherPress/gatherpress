...
const Rsvp = ({
  ...
  const LoggedOutModal = () => {
    ...
    (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('You must %s to RSVP to events.', 'gatherpress'), `<a href=${(0,_helpers_globals__WEBPACK_IMPORTED_MODULE_10__.getFromGlobal)('urls.loginUrl')}>
									${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__._x)('Login', 'Context: You must ~ to RSVP to events.', 'gatherpress')}
								</a>`))), '' !== (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_10__.getFromGlobal)('urls.registrationUrl') && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "gp-modal__text"
    ...
    (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('%s if you do not have an account.', 'gatherpress'), `<a href=${(0,_helpers_globals__WEBPACK_IMPORTED_MODULE_10__.getFromGlobal)('urls.registrationUrl')}>
										${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__._x)('Register', 'Context: ~ if you do not have an account.', 'gatherpress')}
									</a>`)))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ButtonGroup, {
