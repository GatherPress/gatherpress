...
const AttendeeList = _ref => {
  ...
  }, false === GatherPress.has_event_past ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No one is attending this event yet.', 'gatherpress') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No one went to this event.', 'gatherpress')), renderedItems);
};
...
const EventItem = props => {
  ...
  }, (0,html_react_parser__WEBPACK_IMPORTED_MODULE_1__["default"])(limitExcerpt(event.excerpt)))), venue && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, venue, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"gatherpress/events-list","version":"0.2","title":"Events List","category":"gatherpress","icon":"list-view","example":{},"description":"A block listing events.","attributes":{"eventOptions":{"type":"object","default":{"descriptionLimit":55,"imageSize":"default","showAttendeeList":true,"showFeaturedImage":true,"showDescription":true,"showRsvpButton":true}},"maxNumberOfEvents":{"type":"integer","default":5},"topics":{"type":"array","items":{"type":"object"}},"type":{"type":"string","default":"upcoming"}},"supports":{"html":false},"textdomain":"gatherpress","editorScript":"file:./index.js","style":"file:./style-index.css","viewScript":"file:./events-list.js","render":"file:./render.php"}');
