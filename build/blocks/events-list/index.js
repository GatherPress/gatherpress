...
const Rsvp = ({
  ...
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__._n)('%d guest', '%d guests', {
    rsvpGuests
  }, 'gatherpress'), {
    rsvpGuests
  })))));
  ...
  const responses = {
    upcoming: {
      ...
      not_attending: {
        ...
        text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__._x)('Not Attending', 'responded not attending', 'gatherpress')
      },
      no_status: {
        icon: '',
        text: ''
