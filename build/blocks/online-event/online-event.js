...
/* harmony import */ var _components_OnlineEvent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/OnlineEvent */ "./src/components/OnlineEvent.js");
...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_0___default()(() => {
  const containers = document.querySelectorAll(`[data-gatherpress_block_name="online-event"]`);
  for (let i = 0; i < containers.length; i++) {
    var _attrs$onlineEventLin;
    const attrs = JSON.parse(containers[i].dataset.gatherpress_block_attrs);
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createRoot)(containers[i]).render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_components_OnlineEvent__WEBPACK_IMPORTED_MODULE_2__["default"], {
