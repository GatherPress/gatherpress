...
const displayDateTime = (start, end) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_1___default().tz(start, _helpers_datetime__WEBPACK_IMPORTED_MODULE_4__.timeZone).format(startFormat) + ' to ' + moment__WEBPACK_IMPORTED_MODULE_1___default().tz(end, _helpers_datetime__WEBPACK_IMPORTED_MODULE_4__.timeZone).format(endFormat) + _helpers_datetime__WEBPACK_IMPORTED_MODULE_4__.utcOffset;
};
const Edit = () => {
