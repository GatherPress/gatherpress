...
const displayDateTime = (start, end, tz) => {
  const dateFormat = (0,_helpers_datetime__WEBPACK_IMPORTED_MODULE_7__.convertPHPToMomentFormat)((0,_helpers_globals__WEBPACK_IMPORTED_MODULE_10__.getFromGlobal)('settings.date_format'));
  const timeFormat = (0,_helpers_datetime__WEBPACK_IMPORTED_MODULE_7__.convertPHPToMomentFormat)((0,_helpers_globals__WEBPACK_IMPORTED_MODULE_10__.getFromGlobal)('settings.time_format'));
  const timeZoneFormat = (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_10__.getFromGlobal)('settings.show_timezone') ? 'z' : '';
...
const TimeZone = props => {
  ...
  const choices = (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_5__.getFromGlobal)('timezone_choices');

  // Run only once.
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    setTimezone((0,_helpers_globals__WEBPACK_IMPORTED_MODULE_5__.getFromGlobal)('event_datetime.timezone'));
  }, [setTimezone]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelRow, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SelectControl, {
    ...
    onChange: value => {
      ...
      setTimezone(value);
      (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_5__.setToGlobal)('event_datetime.timezone', value);
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"gatherpress/event-date","version":"1.0.0","title":"Event Date","category":"gatherpress","icon":"clock","example":{},"description":"Displays the date and time for an event.","attributes":{"eventEnd":{"type":"string"},"eventStart":{"type":"string"}},"supports":{"html":false},"textdomain":"gatherpress","editorScript":"file:./index.js","style":"file:./style-index.css","render":"file:./render.php"}');
