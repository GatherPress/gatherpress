...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_0___default()(() => {
  ...
  Object.keys((0,_helpers_globals__WEBPACK_IMPORTED_MODULE_4__.getFromGlobal)('misc.unregisterBlocks')).forEach(key => {
    // Retrieve the block name using the key.
    const blockName = (0,_helpers_globals__WEBPACK_IMPORTED_MODULE_4__.getFromGlobal)('misc.unregisterBlocks')[key];
