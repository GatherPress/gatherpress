<!--
This file is auto-generated by the GatherPress/gatherpress-develop release tooling.
Do not edit it directly: changes are overwritten when the README is regenerated.
To update it, edit the source parts in gatherpress-develop (parts/github/, parts/shared/)
or the assembly in classes/class-cli.php, then regenerate.
-->
