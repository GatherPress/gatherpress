...
- [includes/core/classes/venue/map/class-map.php:1600](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/map/class-map.php#L1600)
```php
