...
- [includes/core/classes/venue/map/class-map.php:1553](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/map/class-map.php#L1553)
```php
