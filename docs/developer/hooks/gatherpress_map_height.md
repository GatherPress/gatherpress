...
- [includes/core/classes/venue/map/class-map.php:1539](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/map/class-map.php#L1539)
```php
