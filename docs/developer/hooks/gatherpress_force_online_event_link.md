...
- [includes/core/classes/event/class-event.php:901](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L901)
```php
