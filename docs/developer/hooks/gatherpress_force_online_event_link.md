...
- [includes/core/classes/event/class-event.php:1145](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L1145)
```php
