...
- [includes/core/classes/event/class-event.php:992](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L992)
```php
