...
- [includes/core/classes/event/class-event.php:981](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L981)
```php
