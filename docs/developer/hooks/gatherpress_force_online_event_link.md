...
- [includes/core/classes/event/class-event.php:995](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L995)
```php
