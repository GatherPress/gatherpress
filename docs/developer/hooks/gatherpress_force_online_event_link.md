...
- [includes/core/classes/event/class-event.php:960](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L960)
```php
