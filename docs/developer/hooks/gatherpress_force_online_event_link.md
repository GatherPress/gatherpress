...
- [includes/core/classes/event/class-event.php:789](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L789)
```php
