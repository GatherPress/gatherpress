...
- [includes/core/classes/event/class-event.php:978](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L978)
```php
