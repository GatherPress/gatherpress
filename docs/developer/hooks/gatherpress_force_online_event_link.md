...
- [includes/core/classes/event/class-event.php:1130](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L1130)
```php
