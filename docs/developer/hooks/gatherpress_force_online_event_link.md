...
- [includes/core/classes/event/class-event.php:1122](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L1122)
```php
