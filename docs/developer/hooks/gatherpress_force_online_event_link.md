...
- [includes/core/classes/event/class-event.php:910](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-event.php#L910)
```php
