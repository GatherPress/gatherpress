...
- [includes/core/classes/class-venue-map-prewarm.php:102](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-venue-map-prewarm.php#L102)
```php
