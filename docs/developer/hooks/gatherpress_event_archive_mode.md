...
- [includes/core/classes/event/class-setup.php:590](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-setup.php#L590)
```php
