...
- [includes/core/classes/event/class-setup.php:538](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-setup.php#L538)
```php
