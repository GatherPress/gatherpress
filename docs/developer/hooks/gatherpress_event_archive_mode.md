...
- [includes/core/classes/event/class-setup.php:515](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-setup.php#L515)
```php
