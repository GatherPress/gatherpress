...
- [includes/core/classes/event/class-setup.php:537](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-setup.php#L537)
```php
