...
- [includes/core/classes/event/class-setup.php:559](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-setup.php#L559)
```php
