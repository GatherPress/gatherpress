...
- [includes/core/classes/class-venue-setup.php:875](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-venue-setup.php#L875)
```php
apply_filters(
			'gatherpress_venue_post_type',
			Venue::POST_TYPE,
