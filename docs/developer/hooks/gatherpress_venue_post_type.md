...
- [includes/core/classes/venue/class-setup.php:666](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/class-setup.php#L666)
```php
apply_filters(
			'gatherpress_venue_post_type',
			Venue::POST_TYPE,
