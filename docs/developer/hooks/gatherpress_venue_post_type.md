...
- [includes/core/classes/venue/class-setup.php:716](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/class-setup.php#L716)
```php
apply_filters(
			'gatherpress_venue_post_type',
			Venue::POST_TYPE,
