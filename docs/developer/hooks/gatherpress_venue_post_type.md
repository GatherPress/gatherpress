...
- [includes/core/classes/venue/class-setup.php:682](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/class-setup.php#L682)
```php
apply_filters(
			'gatherpress_venue_post_type',
			Venue::POST_TYPE,
