...
- [includes/core/classes/class-venue-setup.php:865](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-venue-setup.php#L865)
```php
apply_filters(
			'gatherpress_venue_post_type',
			Venue::POST_TYPE,
