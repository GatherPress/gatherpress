...
- [includes/core/classes/venue/class-setup.php:427](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/class-setup.php#L427)
```php
