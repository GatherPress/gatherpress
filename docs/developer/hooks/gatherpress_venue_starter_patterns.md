...
- [includes/core/classes/venue/class-setup.php:328](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/class-setup.php#L328)
```php
