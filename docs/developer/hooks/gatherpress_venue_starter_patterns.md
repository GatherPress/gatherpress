...
- [includes/core/classes/venue/class-setup.php:320](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/class-setup.php#L320)
```php
