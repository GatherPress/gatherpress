...
- [includes/core/classes/venue/class-setup.php:377](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/class-setup.php#L377)
```php
