...
- [includes/core/classes/event/class-setup.php:359](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-setup.php#L359)
```php
