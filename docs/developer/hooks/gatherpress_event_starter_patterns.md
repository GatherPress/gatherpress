...
- [includes/core/classes/event/class-setup.php:279](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-setup.php#L279)
```php
