...
- [includes/core/classes/event/class-setup.php:328](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-setup.php#L328)
```php
