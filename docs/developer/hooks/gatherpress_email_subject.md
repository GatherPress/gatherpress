...
- [includes/core/classes/event/class-rest-api.php:587](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/event/class-rest-api.php#L587)
```php
