...
- [includes/core/classes/venue/map/class-prewarm.php:129](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/venue/map/class-prewarm.php#L129)
```php
