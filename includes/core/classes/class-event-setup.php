	...
	protected function setup_hooks(): void {
		...
		add_action(
			...
			function () {
				...
				add_filter(
					'query_vars',
					function ( array $public_query_vars ): array {
				...
				add_action(
					...
					function (): void {
						...
						if ( in_array( get_query_var( 'gatherpress_ext_calendar' ), array( 'googlecalendar', 'yahoocalendar' ), true ) ) {
							/**
						...
						if ( in_array( strtolower( get_query_var( 'gatherpress_ext_calendar' ) ), array( 'ical', 'outlook' ), true ) ) {
							/**
							...
							add_filter(
								...
								function ( string $template ): string {
									...
									// Prepare the path to the ical-template from inside the plugin folder.
									$file_path = sprintf(
