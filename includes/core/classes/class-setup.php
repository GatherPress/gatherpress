...
class Setup {
	...
	public function check_users_can_register() {
		...
		if ( isset( $_REQUEST['action'] ) && 'suppress_gp_membership_notification' === $_REQUEST['action'] && isset( wp_unslash( $_GET['_wpnonce'] ) ) && wp_verify_nonce( wp_unslash( $_GET['_wpnonce'] ), 'clear-notification' ) ) {
