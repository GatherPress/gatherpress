...
- Custom taxonomies on RSVP comments: `_gatherpress_rsvp_status`, `_gatherpress_rsvp_provider`, and `_gatherpress_rsvp_flag` (yes/no markers, each a subclass of `Rsvp\Flag\Base`; see `docs/developer/rsvp/README.md`)
