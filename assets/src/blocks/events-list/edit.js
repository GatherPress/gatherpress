...
import { PanelBody, RangeControl, ButtonGroup, Button, __experimentalText as Text } from '@wordpress/components';
/**
	...
	return (
		<div {...blockProps}>
			<InspectorControls>
				...
				<PanelBody>
					<RangeControl
						label={__('Maximum number of events to display?', 'gatherpress')}
						min={1}
						max={10}
			...
			<EventsList maxNumberOfEvents={attributes.maxNumberOfEvents} type={attributes.type} />
		</div>
	);
};
