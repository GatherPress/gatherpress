...
const Edit = props => {
  ...
  const excerptMax = 55;
  const topicSuggestions = (_topicsList$reduce = topicsList === null || topicsList === void 0 ? void 0 : topicsList.reduce((accumulator, topic) => ({ ...accumulator,
    [topic.name]: topic
